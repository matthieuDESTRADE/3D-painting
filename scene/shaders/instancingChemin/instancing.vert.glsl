...
layout (location = 10) in vec3 instance_rotation_x;  // instance position  (x,y,z)
layout (location = 11) in vec3 instance_rotation_y;  // instance position  (x,y,z)
layout (location = 12) in vec3 instance_rotation_z;  // instance position  (x,y,z)
layout (location = 8) in vec3 instance_color;  // instance position  (x,y,z)
layout (location = 13) in vec2 instance_text;  // instance position  (x,y,z)
